#!/usr/bin/env python3
"""
Complete conversion of Chapter 13 CNXML files to PreTeXt format
"""
...
def main():
    ...
    output += '<chapter xml:id="ch13-f-distribution-anova" xmlns:xi="http://www.w3.org/2001/XInclude">\n'
    output += '  <title>F Distribution and One-Way ANOVA</title>\n\n'
    output += section1
    output += section2
    output += section3
    output += section4
    ...
    # Write output
    output_path = Path('pretext/source/ch13-f-distribution-anova.ptx')
