#!/usr/bin/env python3
"""
Complete conversion of Chapter 12 CNXML files to PreTeXt format
"""
...
def main():
    ...
    print("Converting m79700 (Linear Equations)...")
    section1 = convert_module(
        modules_dir / 'm79700' / 'index.cnxml',
        'sec-linear-equations',
        'Linear Equations'
    )
    
    print("Converting m79686 (Scatter Plots)...")
    section2 = convert_module(
        modules_dir / 'm79686' / 'index.cnxml',
        'sec-scatter-plots',
        'Scatter Plots'
    )
    
    print("Converting m79689 (The Regression Equation)...")
    section3 = convert_module(
        modules_dir / 'm79689' / 'index.cnxml',
        'sec-regression-equation',
        'The Regression Equation'
    )
    
    print("Converting m79691 (Testing the Significance of the Correlation Coefficient)...")
    section4 = convert_module(
        modules_dir / 'm79691' / 'index.cnxml',
        'sec-testing-significance-correlation',
        'Testing the Significance of the Correlation Coefficient'
    )
    
    print("Converting m79692 (Prediction)...")
    section5 = convert_module(
        modules_dir / 'm79692' / 'index.cnxml',
        'sec-prediction',
        'Prediction'
    )
    
    print("Converting m79694 (Outliers)...")
    section6 = convert_module(
        modules_dir / 'm79694' / 'index.cnxml',
        'sec-outliers',
        'Outliers'
    )
    
    print("Converting m79695 (Regression - Distance from School)...")
    section7 = convert_module(
        modules_dir / 'm79695' / 'index.cnxml',
        'sec-regression-distance',
        'Regression (Distance from School)'
    )
    
    print("Converting m79697 (Linear Regression and Correlation: Review)...")
    section8 = convert_module(
        modules_dir / 'm79697' / 'index.cnxml',
        'sec-regression-review',
        'Linear Regression and Correlation: Review'
    )
    
    print("Converting m79699 (Linear Regression and Correlation: Practice)...")
    section9 = convert_module(
        modules_dir / 'm79699' / 'index.cnxml',
        'sec-regression-practice',
        'Linear Regression and Correlation: Practice'
    )
    
    # Assemble final document
    output = '<?xml version="1.0" encoding="UTF-8"?>\n'
    output += '<chapter xml:id="ch12-linear-regression-correlation" xmlns:xi="http://www.w3.org/2001/XInclude">\n'
    output += '  <title>Linear Regression and Correlation</title>\n\n'
    output += section1
    output += section2
    output += section3
    output += section4
    ...
    # Write output
    output_path = Path('pretext/source/ch12-linear-regression-correlation.ptx')
