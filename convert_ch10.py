#!/usr/bin/env python3
"""
Complete conversion of Chapter 10 CNXML files to PreTeXt format
"""
...
def main():
    ...
    # Convert introduction (m79667)
    print("Converting m79667 (Introduction)...")
    intro_section = convert_module(
        modules_dir / 'm79667' / 'index.cnxml',
        'sec-hypothesis-testing-two-samples-intro',
        'Introduction'
    )
    
    # Convert each section in correct order
    print("Converting m79668 (Two Population Means with Unknown Standard Deviations)...")
    section1 = convert_module(
        modules_dir / 'm79668' / 'index.cnxml',
        'sec-two-population-means-unknown-stddev',
        'Two Population Means with Unknown Standard Deviations'
    )
    
    print("Converting m79669 (Two Population Means with Known Standard Deviations)...")
    section2 = convert_module(
        modules_dir / 'm79669' / 'index.cnxml',
        'sec-two-population-means-known-stddev',
        'Two Population Means with Known Standard Deviations'
    )
    
    print("Converting m79670 (Comparing Two Independent Population Proportions)...")
    section3 = convert_module(
        modules_dir / 'm79670' / 'index.cnxml',
        'sec-comparing-two-proportions',
        'Comparing Two Independent Population Proportions'
    )
    
    print("Converting m79672 (Matched or Paired Samples)...")
    section4 = convert_module(
        modules_dir / 'm79672' / 'index.cnxml',
        'sec-matched-paired-samples',
        'Matched or Paired Samples'
    )
    
    print("Converting m79671 (Hypothesis Testing for Two Means and Two Proportions - Practice)...")
    section5 = convert_module(
        modules_dir / 'm79671' / 'index.cnxml',
        'sec-hypothesis-testing-two-samples-practice',
        'Hypothesis Testing with Two Samples: Practice'
    )
    
    # Assemble final document
    output = '<?xml version="1.0" encoding="UTF-8"?>\n'
    output += '<chapter xml:id="ch10-hypothesis-testing-two-samples" xmlns:xi="http://www.w3.org/2001/XInclude">\n'
    output += '  <title>Hypothesis Testing with Two Samples</title>\n\n'
    ...
    # Write output
    output_path = Path('pretext/source/ch10-hypothesis-testing-two-samples.ptx')
